module.exports = class Vendedor {
    ...
    #salarioBase;
    #porcentagemCom;
        constructor(nome, cpf, dataNasc, dataCont, salarioBase, porcentagemCom) {
            this.nome = nome;
            this.cpf = cpf;
        ...
        toJSON() {
            return {
                ...
                porcentagemCom: this.porcentagemCom, 
            }
        }
        ...
        set porcentagemCom(porcentagemCom) {
            if(porcentagemCom <= 0 || porcentagemCom > 100) {
                throw "porcentagemCom Inválido";
                console.log("porcentagemCom Inválido")
            }
    
            this.#porcentagemCom = porcentagemCom.trim();
        }
}